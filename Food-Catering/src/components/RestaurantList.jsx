...
//                 <button onClick={scrollLeft} className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full shadow-md">
//                     <FaChevronLeft />
//                 </button>
...
//                                 className="bg-white shadow-lg rounded-lg overflow-hidden min-w-[250px] flex flex-col h-[300px]"
//                             >
//                                 {/* Restaurant Image */}
//                                 <img
//                                     src={RestaurantPhoto}
...
//                                     <div className="mt-auto text-orange-500 font-bold bg-gray-100 p-2 rounded-b-lg text-left">
//                                         ⭐ {restaurant.rating}
//                                     </div>
//                                 </div>
//                             </div>
...
//                 <button onClick={scrollRight} className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full shadow-md">
//                     <FaChevronRight />
//                 </button>
//             </div>
//         </div>
