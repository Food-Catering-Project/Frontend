...
//         setCart((prevCart) => {
//             const itemIndex = prevCart.findIndex((cartItem) => cartItem.menuId === item.menuId);
//             if (itemIndex >= 0) {
//                 // Update quantity if the item already exists in the cart
//                 const updatedCart = [...prevCart];
//                 updatedCart[itemIndex].quantity += 1;
//                 updatedCart[itemIndex].totalPrice += item.price;
//                 return updatedCart;
//             } else {
...
//     const vegItems = activeTab === "veg" ? vegMenus : nonVegMenus;
...
//                                 className="w-full bg-orange-600 text-white py-2 mt-3 rounded-full hover:bg-orange-700 transition duration-300"
//                             >
//                                 Add to Cart
//                             </button>
//                         </motion.div>
